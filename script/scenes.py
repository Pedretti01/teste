...
class Login(Scene):
    ...
    def __init__(self):
        ...
        self.exit_button = Obj("assets/login/Button2.png", [541, 552], [self.all_sprites])  # Botão de Sair
...
class Level(Scene):
        ...
        if event.type == pygame.KEYDOWN:  # Certifique-se de que é um evento de tecla
            ...
            # Avança no diálogo ou responde à questão
                ...
                if self.chatbox.options:  # Responde à questão
                    ...
                    if selected_option == self.questions[self.current_question]["resposta_correta"]:
                        print("Resposta correta!")
                        self.chatbox.score += 1  # Incrementa a pontuação se a resposta for correta
                    else:
                    ...
                    if self.current_question < len(self.questions):
                        ...
                        self.chatbox.display_question(
                            question_data["titulo"],  # Título da pergunta
                            question_data["pergunta"],  # Texto da pergunta
                            question_data["opcoes"]  # Opções de resposta
                        )
                    else:
    ...
    def update(self):
        ...
        self.hud.update_life(self.player.life)  # Atualiza os pontos de sangue
